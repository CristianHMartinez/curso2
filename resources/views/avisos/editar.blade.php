...
@section('contenido')
    <form method="POST" action="{{ route('avisos.update', $post, false) }}" class="max-w-lg mx-auto p-8 bg-white rounded-lg shadow mt-8">
        @csrf
        @method('PUT')
        ...
        <label class="block text-sm font-medium text-gray-700 mb-1 mt-4">Categoria</label>
